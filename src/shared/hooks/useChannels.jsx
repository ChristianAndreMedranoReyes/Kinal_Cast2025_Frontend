...
import { getChannels as getChannelsRequest, getFollowedChannels, getFollowedChannels } from "../../services/api";

export const useChannels = () => {

    const [ channels, setChannels ] = useState(null)

    const getChannels = async (isLooged = false) => {
        ...
        const getFollowedChannels = await getFollowedChannels();
        ...
        setChannels({
            ...
            followedChannels: channelsData.data.channels.filter( channel => 
                followedChannelsIsData.data.followedChannels.includes(channel.id)
            )
        })
    }
